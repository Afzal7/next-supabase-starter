...
import { useGetGroupQuery, useUpdateMemberMutation, useRemoveMemberMutation } from "@/lib/rtk/api";
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold">{groupConfig.entityName} Members</h3>
      ...
      {group.members && group.members.length > 0 ? (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() => {
                            if (confirm(`Remove ${member.user?.name || member.user?.email} from the group?`)) {
        ...
        <Card>
          <CardContent className="p-12 text-center">
            <Users className="h-12 w-12 text-muted-foreground mx-auto mb-4" animateOnHover />

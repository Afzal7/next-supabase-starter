    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      >
        <Card className="shadow-sm">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-primary">Update Password</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <form onSubmit={handleUpdatePassword} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="confirm-password" className="text-sm font-medium capitalize text-tertiary">
                  Confirm Password
                </Label>
                <div className="relative">
                  <Input
